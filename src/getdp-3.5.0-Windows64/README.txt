...
The examples/ directory contains a simple example. For more examples see the
reference manual (http://getdp.info/doc/texinfo/) and the ONELAB web site
(http://onelab.info).
...
* If you are looking for a graphical user interface to GetDP, download Gmsh
  (http://gmsh.info). To launch GetDP via Gmsh, simply open Gmsh, go to the
