"""develop_fea_example_10.py - Motor FEA with User-Controlled Mesh and Nonlinear Steel
====================================================================================
...
and optimized rotor geometry. The stator uses a segmented inner boundary that traces 
around slot openings for physically accurate geometry.
...
- MESH_ROTOR_CORE: Maximum element size in rotor core (default 5mm)
- MESH_MAGNET: Maximum element size in magnets (default 1mm)
- MESH_AIRGAP: Maximum element size at airgap and tooth tips (default 0.3mm, critical)
- MESH_STATOR_CORE: Maximum element size in stator core (default 5mm)
...
- All output files and plots saved to develop_fea_example_10_output/
...
work_dir = os.path.join(script_dir, 'develop_fea_example_10_output')
...
// Generated by develop_fea_example_10.py
