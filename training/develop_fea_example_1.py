"""develop_fea_example_1.py - C-Core Permanent Magnet FEA Example
=================================================================

This is the foundational FEA example that validates the GetDP magnetostatic 
...
work_dir = os.path.join(script_dir, 'develop_fea_example_1_output')
...
// Generated by develop_fea_example_1.py
...
def main():
    ...
    print("\n")
    print("*" * 60)
    print("C-Core FEA Example - Complete Workflow")
    ...
    print("\n" + "*" * 60)
    print("FEA EXAMPLE COMPLETED SUCCESSFULLY!")
    print("*" * 60)
    print()
    ...
    print()
    print("This example validates the complete GetDP workflow!")
