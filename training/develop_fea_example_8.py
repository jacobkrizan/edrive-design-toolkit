"""develop_fea_example_8.py - Motor FEA with Slotted Stator and Segmented Inner Boundary
=================================================================================

This script builds a complete FEA model of a surface-mounted PM motor with a steel 
rotor core and a slotted stator. The stator uses a segmented inner boundary that 
traces around slot openings, creating physically accurate slot geometry for FEA.
...
- All output files and plots saved to develop_fea_example_8_output/
...
work_dir = os.path.join(script_dir, 'develop_fea_example_8_output')
...
// Generated by develop_fea_example_8.py
