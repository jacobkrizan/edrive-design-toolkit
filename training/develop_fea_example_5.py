"""develop_fea_example_5.py - Complete Motor FEA with Dynamic Excel Parameters
==============================================================================

This example demonstrates a complete permanent magnet motor FEA workflow with
dynamic parameter loading from Excel and comprehensive visualization.

Features:
- Dynamic parameter loading from Excel file (projects/example_design_1/)
- Complete motor geometry visualization (shaft, rotor, magnets, stator, slots)
...
- Rotor: 50mm ID, 138mm OD
- Magnets: 4mm thick, 80% arc ratio, surface-mounted
...
Geometry Structure:
- Inner air: center to airgap middle with magnet cutouts
- Outer air: airgap middle to stator OD + 2mm
- Shell: stator OD + 2mm to stator OD + 10mm (far-field boundary)
...
Expected Results:
- Flux density: 0.04-0.78 T peak
- Airgap flux: sinusoidal 8-pole pattern
- Mesh: ~36,000 nodes, ~73,000 elements
- Solver: ~36,000 DOFs, convergence < 1e-10
"""
...
work_dir = os.path.join(script_dir, 'develop_fea_example_5_output')
...
// Generated by develop_fea_example_5.py
