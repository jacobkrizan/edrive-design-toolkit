"""develop_fea_example_4.py - 8-Pole Rotor with Airgap and Python Analysis
=========================================================================

This example extends develop_fea_example_3 by adding a realistic airgap structure
...
Key Differences from develop_fea_example_3:
...
work_dir = os.path.join(script_dir, 'develop_fea_example_4_output')
...
// Generated by develop_fea_example_4.py
